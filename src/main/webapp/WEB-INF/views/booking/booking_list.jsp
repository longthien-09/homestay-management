        ...
        <table>
            ...
            <% if (bookings != null && !bookings.isEmpty()) { int i=1; for (Map<String,Object> r : bookings) { %>
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <form method="post" action="/homestay-management/manager/bookings/<%= r.get("id") %>/approve" style="display:inline;">
                                <button class="btn btn-approve" type="submit">Duyệt</button>
                            </form>
                            <form method="post" action="/homestay-management/manager/bookings/<%= r.get("id") %>/reject" style="display:inline;">
