...
public class RoomDao {
    ...
    public int addRoom(Room room) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            ps.setString(1, n(room.getRoomNumber()));
            ps.setString(2, n(room.getType()));
            ps.setBigDecimal(3, room.getPrice());
            ps.setString(4, n(room.getStatus()));
            ps.setString(5, n(room.getDescription()));
            ps.setString(6, n(room.getImage()));
